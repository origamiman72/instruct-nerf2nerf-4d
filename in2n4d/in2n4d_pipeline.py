...
from in2n4d.in2n4d_datamanager import (
    InstructNeRF2NeRF4DDataManagerConfig,
)
from in2n.ip2p import InstructPix2Pix


@dataclass
class InstructNeRF2NeRF4DPipelineConfig(VanillaPipelineConfig):
    """Configuration for pipeline instantiation"""

    _target: Type = field(default_factory=lambda: InstructNeRF2NeRF4DPipeline)
    """target class to instantiate"""
    datamanager: InstructNeRF2NeRF4DDataManagerConfig = InstructNeRF2NeRF4DDataManagerConfig()
...
class InstructNeRF2NeRF4DPipeline(VanillaPipeline):
    """InstructNeRF2NeRF pipeline"""

    config: InstructNeRF2NeRF4DPipelineConfig
