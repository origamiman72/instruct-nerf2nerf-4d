...
@dataclass
class InstructNeRF2NeRF4DDataManagerConfig(VanillaDataManagerConfig):
    """Configuration for the InstructNeRF2NeRFDataManager."""

    _target: Type = field(default_factory=lambda: InstructNeRF2NeRF4DDataManager)
    patch_size: int = 32
    """Size of patch to sample from. If >1, patch-based sampling will be used."""

class InstructNeRF2NeRF4DDataManager(VanillaDataManager[DepthDataset]):
    """Data manager for InstructNeRF2NeRF."""

    config: InstructNeRF2NeRF4DDataManagerConfig
